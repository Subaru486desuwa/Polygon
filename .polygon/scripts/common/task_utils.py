...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .polygon/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .polygon)
    if "/" in normalized or normalized.startswith(".polygon"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.polygon/tasks/test'): {is_safe_task_path('.polygon/tasks/test', repo)}")
