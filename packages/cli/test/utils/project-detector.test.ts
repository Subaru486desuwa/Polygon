...
describe("detectProjectType", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "polygon-detect-"));
  });
...
describe("detectMonorepo", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "polygon-monorepo-"));
  });
  ...
  it("merges pnpm workspace + .gitmodules and marks submodule", () => {
    ...
    mkPkg("packages/cli", "@polygon/cli");
    mkPkg("docs-site", "docs-site");
...
describe("detectMonorepo polyrepo fallback", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "polygon-poly-"));
  });
