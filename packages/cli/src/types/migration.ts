/**
 * Migration types for Polygon update command
 *
 ...
 *
 * Used by `polygon update` to append the section to existing user config files
...
export interface ConfigSectionAdded {
  /** Target file relative to project root (e.g. `.polygon/config.yaml`). */
  file: string;
  /**
