#!/usr/bin/env python3
"""
Standalone reader for .polygon/config.yaml.
...
CONFIG_REL_PATH = ".polygon/config.yaml"
...
def read_polygon_config(repo_root: Optional[Path] = None) -> dict:
    """Read .polygon/config.yaml. Returns {} on missing or malformed file."""
