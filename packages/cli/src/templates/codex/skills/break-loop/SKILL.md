...
5. **Capture** — actually update `.polygon/spec/` (the `update-spec` skill has the format). A list of TODOs is not capture; the edited spec file is.
