...
```bash
python3 ./.polygon/scripts/init_developer.py <your-name>
```
...
1. Get your developer name:
   ```bash
   python3 ./.polygon/scripts/get_developer.py
   ```

2. Read your personal index:
   ```bash
   cat .polygon/workspace/$(python3 ./.polygon/scripts/get_developer.py)/index.md
   ```
